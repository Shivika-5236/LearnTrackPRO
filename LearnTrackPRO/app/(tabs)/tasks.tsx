        ...
        {task ? (
          ...
          >
            <View style={styles.taskHeader}>
              ...
              <View style={[styles.priorityBadge, { backgroundColor: isDark ? '#2D1F2D' : '#FEF2F2' }]}>
    ...
    <SafeAreaView style={[styles.safeArea, { backgroundColor }]}>
      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.topStatsRow}>
          <Text style={[styles.taskCountText, { color: subtextColor }]}>
            {tasks.length} {tasks.length === 1 ? 'Task' : 'Tasks'}
          </Text>
          <TouchableOpacity 
            style={[styles.addInlineBtn, { backgroundColor: accentColor }]}
        ...
        {renderTaskSection('Not Started', 'Not started', '#F5A23A')}
        {renderTaskSection('Doing', 'Doing', '#7C6AF7')}
        {renderTaskSection('Completed', 'Completed', '#3ECFA8')}
      </ScrollView>
